...
struct omni_context {
    ...
    // 设置为 0 表示无限制
    // 🔧 [与 Python 对齐] Python _default_duplex_params["max_new_speak_tokens_per_chunk"] = 20
    // 模型设计: 每 chunk 最多 20 token，到上限强制注入 chunk_eos
    int max_new_speak_tokens_per_chunk = 20;
